 ...
 */
export const CurrencyDisplay: StoryObj<IntlTextProps> = {
  args: {
    formatType: "number",
    value: 5000,
    formatOptions: {
 ...
 */
export const ViewsCount: StoryObj<IntlTextProps> = {
  args: {
    formatType: "number",
    value: 1050000,
    formatOptions: {
 ...
 */
export const FullDateDisplay: StoryObj<IntlTextProps> = {
  args: {
    formatType: "date",
    value: "04/20/1988",
    formatOptions: {
 ...
 */
export const ShortDateDisplay: StoryObj<IntlTextProps> = {
  args: {
    formatType: "date",
 ...
 */
export const RelativeTimeDisplay: StoryObj<IntlTextProps> = {
  args: {
