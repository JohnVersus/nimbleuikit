...
This can either be a CSSObject, or a function that receives the theme and returns a CSSObject.`,name:"css",required:!1,type:{name:"CSSObject | ((theme: any) => CSSObject)"}},theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"any"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"undefined"}}}}}catch{}const X={title:"Atoms/Button",component:d,tags:["autodocs"],argTypes:{color:{control:"color"},bg:{control:"color"}},parameters:{docs:{description:{component:"Refer to [Props Details](?path=/docs/propsdetails--documentation) for details on the available props."}}}},e={args:{p:2,children:"Default Button"}};e.storyName="Default Button";const t={args:{p:2,color:"white",bg:"gray",children:"Click me!"}};t.storyName="Simple Button";const r={args:{p:2,color:"blue",bg:"pink",border:"2px solid purple",borderRadius:"5px",children:"Styled Button"}};r.storyName="Styled Button";const o={args:{p:2,color:"white",bg:"green",boxShadow:"2px 2px 2px 1px rgba(0, 0, 0, 0.2)",children:"Button With Shadow"}};o.storyName="Button With Shadow";const s={args:{p:2,color:"black",bg:"yellow",css:{cursor:"progress"},children:"Cursor Button"}};s.storyName="Cursored Button";const n={args:{p:2,children:"Click Me!!",onClick:()=>{alert("Button Clicked")}}};n.storyName="Clickable Button";const a={args:{p:2,children:"Disabled",disabled:!0}};a.storyName="Disabled Button";var i,l,p,u,m;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    p: 2,
    children: "Default Button"
  }
}`,...(p=(l=e.parameters)==null?void 0:l.docs)==null?void 0:p.source},description:{story:"A default button with no additional styling.",...(m=(u=e.parameters)==null?void 0:u.docs)==null?void 0:m.description}}};var h,b,g,y,B;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    p: 2,
    color: "white",
    bg: "gray",
...
//# sourceMappingURL=Button.stories-209c02ef.js.map
